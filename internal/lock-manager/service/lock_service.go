...
type LockServiceI interface {
	...
	//
	// If given resourceID is not valid, then service.ErrInvalidResourceID is returned.
	//
	// If given resourceID is already locked, then provider.ErrLockAlreadyExists is
	// returned.
